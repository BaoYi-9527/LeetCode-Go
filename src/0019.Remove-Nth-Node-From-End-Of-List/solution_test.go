...
func TestRemoveNthNodeFromEndOfList(t *testing.T) {
	headList := IntArr2List([]int{1, 2, 3, 4, 5})
	n := 2
	expect := []int{1, 2, 3, 5}
	calcResArr := List2IntArr(removeNthFromEnd(headList, n))
	//calcResArr := List2IntArr(removeNthFromEnd1(headList, n))
